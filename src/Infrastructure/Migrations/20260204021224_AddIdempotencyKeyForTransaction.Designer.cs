...
namespace CoreAPI.Migrations
{
    ...
    [Migration("20260204021224_AddIdempotencyKeyForTransaction")]
    partial class AddIdempotencyKeyForTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<decimal>("Amount")
                        .HasColumnType("DECIMAL(18,2)")
                        .HasAnnotation("CheckConstraint", "Amount != 0");
                    ...
                    b.Property<DateTimeOffset>("OccurredAt")
                        .HasColumnType("DATETIMEOFFSET(3)")
                        .HasAnnotation("CheckConstraint", "OccurredAt <= CreatedAt");
            ...
            modelBuilder.Entity("Domain.Entities.TransactionType", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Slug")
                        .IsUnique()
                        .HasFilter("[Slug] <> '' AND [IsDeleted] = 0");
            ...
            modelBuilder.Entity("Domain.Entities.Tenant", b =>
                {
                    b.HasOne("Domain.Entities.User", "PerformByUser")
                        .WithMany()
                        .HasForeignKey("PerformBy");

                    b.OwnsOne("Domain.Entities.AccountSetting", "Setting", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Customer", "Referencer")
                        .WithMany()
