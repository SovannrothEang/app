...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251219142806_InitializeDB")]
            ...
            modelBuilder.Entity("Domain.Models.LoyaltyAccount", b =>
                {
                    ...
                    b.OwnsMany("Domain.ValueObjects.PointTransaction", "PointTransactions", b1 =>
                        {
                            b1.Property<string>("LoyaltyAccountCustomerId")
                                .HasColumnType("VARCHAR(100)");

                            b1.Property<string>("LoyaltyAccountTenantId")
                                .HasColumnType("VARCHAR(100)");
                            ...
                            b1.HasKey("LoyaltyAccountCustomerId", "LoyaltyAccountTenantId", "Id");

                            b1.ToTable("PointTransaction");

                            b1.WithOwner()
                                .HasForeignKey("LoyaltyAccountCustomerId", "LoyaltyAccountTenantId");
                        });
