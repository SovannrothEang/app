...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251220112043_RemovedGhostEntities")]
    partial class RemovedGhostEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.LoyaltyAccount", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.PointTransaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("VARCHAR(100)");
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.Tenant", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("VARCHAR(100)");
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.LoyaltyAccount", b =>
                {
                    b.HasOne("WebAPI.Domain.Models.Customer", null)
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.PointTransaction", b =>
                {
                    b.HasOne("WebAPI.Domain.Models.LoyaltyAccount", null)
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.Tenant", b =>
                {
                    b.OwnsOne("WebAPI.Domain.ValueObjects.LoyaltyProgramSetting", "Setting", b1 =>
                        {
            ...
            modelBuilder.Entity("WebAPI.Domain.Models.User", b =>
                {
                    b.HasOne("WebAPI.Domain.Models.Tenant", null)
                        .WithOne("User")
                        .HasForeignKey("WebAPI.Domain.Models.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI.Domain.Models.Tenant", "Tenant")
                        .WithMany()
                        .HasForeignKey("TenantId");
